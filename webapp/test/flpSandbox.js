		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapbtpprintfullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpprintfullscreen-display": {
								"semanticObject": "sapbtpprintfullscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.printfullscreen",
									"url": sap.ui.require.toUrl("sap/btp/printfullscreen")
								}
							}
						}
					}
